...
import fr.benguiza.presentationlayer.tools.inflate
import fr.benguiza.presentationlayer.tools.removeOnClickListener
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (position != RecyclerView.NO_POSITION) {
            ...
            holder.itemView.setOnClickListener {
                holder.onClick(items[position], position)
